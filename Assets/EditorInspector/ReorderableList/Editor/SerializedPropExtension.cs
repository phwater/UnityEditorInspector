...
namespace EditorInspector {
    ...
    internal static class SerializedPropExtension {
        ...
        public static Type GetTypeReflection(this SerializedProperty prop) {
            ...
            const BindingFlags bindingFlags = BindingFlags.GetField | BindingFlags.GetProperty | BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public;
        ...
        public static SerializedProperty[] FindPropsOfType<T>(this SerializedObject obj, bool enterChildren = false) {
            ...
            SerializedProperty iterProp = obj.GetIterator();
            iterProp.Next(true);

            if (iterProp.NextVisible(enterChildren)) {
                do {
                    System.Object propValue = iterProp.GetValue<T>();
                    if (propValue == null) {
